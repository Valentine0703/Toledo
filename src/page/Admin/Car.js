...
function CarContent() {
    ...
    const saveCar = () =>{
        setModal(false);
        axios.post("http://localhost:8080/addcar",[name, price, newUserInfo.profileImages[0].name])
        .then(res=>{
            setRows(res.data);
        })
        .catch(err=>{
    ...
    const deleteCar = (key) =>{
        console.log(key);
        axios.post("http://localhost:8080/delcar",[key])
        .then(res=>{
            setRows(res.data);
        })
        .catch(err=>{
                                    ...
                                    <TableBody>
                                        {rows.map((row, rowkey) => (
                                            <TableRow key={row.id}>
                                                ...
                                                <TableCell ><img src={`../assets/${row.file}`} width="30%" /></TableCell>
