            ...
            <Container fullWidth>
                ...
                <Box sx={{display:"flex", justifyContent:"space-between"}}>
                    ...
                    <Box width="30%">
                        ...
                        <Typography sx={{textAlign:"justify"}}>Dar respuesta al incremento del flujo de turistas, empresas y particulares que demandan un servicio de transporte privado rápido y eficaz entre Madrid y VTC Toledo.</Typography>
                    </Box>
                    <Box width="30%">
